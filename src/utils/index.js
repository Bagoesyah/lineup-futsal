...
export function load(setName, setMainColor, setSecondaryColor, setNumberColor, setPlayers) {
...
export async function share(name = 'default', mainColor, secondaryColor, numberColor, players, setSpinner) {
  setSpinner(true);
  try {
    const positions = getPlayerPositions();
...
export async function loadSharedLineup(id, setName, setMainColor, setSecondaryColor, setNumberColor, setPlayers, setSpinner) {
  setSpinner(true);
  try {
...
export function generatePlayers() {
  const positions = getFormation('2-2');
  const players = [];
  generateName.reset();
