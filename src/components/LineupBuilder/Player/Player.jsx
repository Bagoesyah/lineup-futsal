...
const Player = ({ name, num, x, y, Player, mainColor, secondaryColor, numberColor, id, goal, yellowCard, redCard, setPlayerPosition }) => (
  <Draggable
    bounds={{
      left: 0,
      top: 0,
  ...
  >
    <div
      className="player"
      style={{
        // backgroundImage: url(assets / images / index.jpg),
