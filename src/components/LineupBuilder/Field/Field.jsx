...
import strip from 'assets/tiles/strip.png';
...
const Field = ({ width, height, players, mainColor, secondaryColor, numberColor, id, fieldType, setPlayerPosition, showPositionAreas }) => {
  const positionList = [
  ...
  return (
    ...
    >
      ...
      {showPositionAreas ? <>{positionList.map((position) => position.getArea())}</> : null}
